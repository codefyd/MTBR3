(() => {
  ...
  function renderPerformanceNotice(){document.getElementById('schemaNotice').innerHTML=`<div class="ca-install"><i class="fa-solid fa-gauge-high"></i><div><b>يلزم تثبيت إصلاح الحملات v2.4</b><div>شغّل الملف <span dir="ltr">supabase/campaign_analysis_v2_4_targets_delete_timeout_fix.sql</span> كاملًا في SQL Editor، وانتظر رسالة Success ثم اضغط تحديث التحليل.</div></div></div>`;}
